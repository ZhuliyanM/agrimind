import { ArrowUpRight, Bot, Droplets, ShieldCheck } from 'lucide-react'
import { readinessModules } from '@/modules/field-intelligence/model/shumen-region.ts'
  ...
  return (
    <section className="grid gap-6">
      <article className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6">
        <p className="text-sm uppercase tracking-[0.3em] text-stone-500">Platform posture</p>
